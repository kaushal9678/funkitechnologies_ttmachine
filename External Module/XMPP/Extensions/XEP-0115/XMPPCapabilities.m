...
- (void)collectMyCapabilities
{
    ...
    NSXMLElement *myIdentity = [NSXMLElement elementWithName:@"identity"];
    [myIdentity addAttributeWithName:@"category" stringValue:@"client"];
	...
	[feature4 addAttributeWithName:@"var" stringValue:@"http://jabber.org/protocol/si"];
    NSXMLElement *feature5 = [NSXMLElement elementWithName:@"feature"];
	[feature5 addAttributeWithName:@"var" stringValue:@"http://jabber.org/protocol/si/profile/file-transfer"];
    NSXMLElement *feature6 = [NSXMLElement elementWithName:@"feature"];
	[feature6 addAttributeWithName:@"var" stringValue:@"http://jabber.org/protocol/muc"];
    NSXMLElement *feature7 = [NSXMLElement elementWithName:@"feature"];
	[feature7 addAttributeWithName:@"var" stringValue:@"http://jabber.org/protocol/chatstates"];
