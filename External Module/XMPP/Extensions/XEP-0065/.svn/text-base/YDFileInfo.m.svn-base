...
@end
@implementation YDFileInfo

-(id)initWithFileName:(NSString *)filename mediaType:(NSString *)mediatype mimeType:(NSString *)mimetype size:(long long)fsize localName:(NSString *)localfilename IQ:(NSString *)iq fileNameAsSent:(NSString *)filenameassent sender:(NSString *)sendingjid
{
    self = [super init];
	if ( self != nil)
        {
