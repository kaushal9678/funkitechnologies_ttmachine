...
#import "TTMTextViewInternal.h"

@interface TTMGrowingTextView(private)
-(void)commonInitialiser;
-(void)resizeTextView:(NSInteger)newSizeH;
-(void)growDidStop;
@end

@implementation TTMGrowingTextView
...
#endif
{
    ...
    r.origin.x = 0;
#if __IPHONE_OS_VERSION_MIN_REQUIRED >= 70000
    internalTextView = [[TTMTextViewInternal alloc] initWithFrame:r textContainer:textContainer];
#else
    internalTextView = [[TTMTextViewInternal alloc] initWithFrame:r];
#endif
